/**
 * Footer Section
 * Mobile: brand on top → 2-column links grid → social icons centered
...
export function Footer() {
    ...
    return (
        <footer className="w-full px-4 py-8 lg:px-[120px] bg-surface-elevated border-t border-border">
            <div className="mx-auto max-w-[1200px]">
                        ...
                        <div>
                            ...
                            <ul className="space-y-1.5">
                                {[
                                    ...
                                    <li key={link.href}>
                                        <a href={link.href} className="text-secondary hover:text-accent transition-colors duration-300 text-xs">
                                            {link.label}
                                        </a>
                                    </li>
                                ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {[
                                ...
                                <li key={link.href}>
                                    <a href={link.href} className="text-secondary hover:text-accent transition-colors duration-300 text-sm">
                                        {link.label}
                                    </a>
                                </li>
                            ))}
                ...
                {/* Bottom Bar – shared */}
                <div className="pt-5 lg:pt-8 border-t border-border flex flex-col items-center gap-4 lg:flex-row lg:justify-between">
                    <p className="text-secondary text-xs lg:text-sm order-2 lg:order-1">
