...
/**
 * About Me Section
 * Mobile: compact text → image stacked; Desktop: two-column grid
 */
        ...
        >
            <div ref={ref} className="mx-auto max-w-[1200px]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    <div
                        className={cn(
                            "space-y-3 lg:space-y-4 transition-all duration-700 ease-out delay-200",
                            isVisible
                    ...
                    >
                        ...
                        <p className="text-sm lg:text-lg text-secondary leading-relaxed hidden lg:block">
                        ...
                        <div className="flex gap-3 pt-2 lg:pt-4">
                            <a
                                href="#"
                                className="w-9 h-9 lg:w-10 lg:h-10 rounded-full bg-surface-elevated border border-border flex items-center justify-center hover:bg-accent hover:border-accent transition-all duration-300"
                                aria-label="GitHub"
                            >
                    ...
                    >
                        <div className="relative aspect-[3/4] w-full max-w-[280px] mx-auto lg:max-w-none">
                            <Image
